...
var UI = function() {
  return {
    ...
    /* I have changes from 8.0 to 7.0 to make work in Linux - TODO change back at some point */
    MIN_IE_VERSION : 7.0,
    ...
    init : function() {
      ...
      UI.disable_select();
      /* For development disabled the disable function of context menu - TODO change back at some point */
