...
//.script( path + 'lib/insQ.min.js' )
.script( path + 'lib/select2.full.min.js' )
.script( path + 'lib/jquery.smartmenus.min.js' )
//.script( path + 'lib/html5shiv.min.js' )
//.script( path + 'lib/respond.min.js' )
...
.script( path + 'ui.listboximage.js' ) // As Listbox, but add an extra class
.script( path + 'ui.tagsbox.js' ) // As Listbox, but add an extra class
.script( path + 'ui.radiobutton.js' )
.script( path + 'ui.textbox.js' )
.script( path + 'ui.menuinput.js' )
